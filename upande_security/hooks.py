...
fixtures = [
        ...
        "filters": [
            [
                ...
                [
                    ...
                    "Appointment-custom_entry_gate",
                    "Appointment-custom_exit_gate",
    ...
    },
    {
        ...
        "dt": "Print Format",
        "filters": [
            ["name", "in", ["Visitor Badge Card", "Supplier Badge Card", "Delivery Note - Gate Copy", "Staff Vehicle Sticker Card"]],
        ],
    },
    {
